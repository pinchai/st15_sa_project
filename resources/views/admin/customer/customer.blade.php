                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <input v-model="form.alt_phone" type="text" class="form-control" id="alt_phone">
                            </div>
                            {{--Location--}}
                            <div class="form-group col-12">
    ...
    <script>
        var app = new Vue({
            ...
            methods: {
                fetchRecord() {
                    let vm = this
                    axios.get('/admin/fetchCustomerRecord')
                ...
                createRecord() {
                    let vm = this
                    let input = vm.form
                    axios.post('/admin/createCustomerRecord', input)
                        .then(function (response) {
                            // handle success
                            vm.fetchRecord()
                            vm.resetData()
                ...
                updateRecord() {
                    let vm = this
                    let input = vm.form
                    axios.post('/admin/updateCustomerRecord', input)
                        .then(function (response) {
                            // handle success
                            vm.fetchRecord()
                            vm.resetData()
                ...
                deleteRecord(id) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            let vm = this
                            axios.post('/admin/deleteCustomerRecord', {id: id},
                                {
                                    headers: {

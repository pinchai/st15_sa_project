    ...
    <script>
        var app = new Vue({
            ...
            methods: {
                fetchRecord() {
                    let vm = this
                    axios.get('/admin/fetchBranchRecord')
                ...
                createRecord() {
                    let vm = this
                    let input = vm.form
                    axios.post('/admin/createBranchRecord', input)
                        .then(function (response) {
                            // handle success
                            vm.fetchRecord()
                            vm.resetData()
                ...
                updateRecord() {
                    let vm = this
                    let input = vm.form
                    axios.post('/admin/updateBranchRecord', input)
                        .then(function (response) {
                            // handle success
                            vm.fetchRecord()
                            vm.resetData()
                ...
                deleteRecord(id) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            let vm = this
                            axios.post('/admin/deleteBranchRecord', {id: id},
                                {
                                    headers: {
